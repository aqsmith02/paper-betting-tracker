...
output_df = df[['Match', 'Team', 'Start Time', 'League', 'Best Odds', 
                         'Fair Odds Avg', 'Expected_Value', 'EV_Percent', 
                         'Kelly_Bet_Size', 'Result', 'Profit', 'ROI']].copy()

output_df.to_csv('master_nc_avg_with_ev.csv', index=False)
print(f"Enhanced dataset saved as 'master_nc_avg_with_ev.csv'")

# Save detailed analysis results
analysis_results = df_clean[['Match', 'Team', 'Start Time', 'Best Odds', 'Fair Odds Avg',
                              'Expected_Value', 'EV_Percent', 'Kelly_Bet_Size', 
                              'Result', 'Profit', 'ROI']]
analysis_results.to_csv('ev_kelly_detailed_results.csv', index=False)
print(f"Detailed results saved as 'ev_kelly_detailed_results.csv'")
