...
class TestFindBets:
    ...
    def test_create_average_summary_minimal(
        self, average_bets_data, average_summary_minimal
    ):
    ...
    def test_create_modified_zscore_summary_minimal(
        self, modified_zscore_bets_data, modified_zscore_summary_minimal
    ):
    ...
    def test_create_modified_zscore_summary_full(
        self, modified_zscore_bets_data, modified_zscore_summary_full
    ):
    ...
    def test_create_random_summary_minimal(
        self, random_bets_data, random_summary_minimal
    ):
