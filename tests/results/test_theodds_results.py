...
class TestGetPendingEventIds:
    ...
    def test_single_pending_event(self):
        ...
        df = pd.DataFrame({"ID": ["event123"], "Result": ["Pending"]})
    ...
    def test_no_pending_events(self):
        ...
        df = pd.DataFrame({"ID": ["event1", "event2"], "Result": ["Team A", "Team B"]})
...
class TestAppendResults:
    ...
    def test_single_completed_game_away_win(self):
        ...
        df = pd.DataFrame({"ID": ["event456"], "Result": ["Pending"]})
    ...
    def test_draw_game(self):
        ...
        df = pd.DataFrame({"ID": ["event789"], "Result": ["Pending"]})
    ...
    def test_incomplete_game(self):
        ...
        df = pd.DataFrame({"ID": ["event111"], "Result": ["Pending"]})
    ...
    def test_missing_event_in_api_response(self):
        ...
        df = pd.DataFrame(
            {"ID": ["event1", "event2"], "Result": ["Pending", "Not Found"]}
        )
    ...
    def test_insufficient_scores(self):
        ...
        df = pd.DataFrame({"ID": ["event1"], "Result": ["Pending"]})
